        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            <div className="relative aspect-[3/4] md:aspect-square lg:aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl">
              ...
              />
              <div className="absolute inset-0 bg-espresso/10"></div>
            </div>
          </motion.div>
          ...
          >
            <span className="text-gold uppercase tracking-widest text-sm font-semibold mb-4 block">Bespoke Creations</span>
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-serif text-espresso mb-6 leading-tight">
            ...
            <ul className="space-y-4 mb-10 text-espresso font-medium">
            ...
            <div>
              <button 
                ...
                className="px-8 py-4 bg-espresso text-cream rounded-full font-medium hover:bg-brown transition-colors shadow-lg focus:outline-none focus:ring-2 focus:ring-gold"
              >
        ...
        {isModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 pt-24 pb-10">
            ...
            >
              <button 
                onClick={() => setIsModalOpen(false)}
                className="absolute top-4 right-4 md:top-8 md:right-8 p-2 bg-cream/80 backdrop-blur-md rounded-full text-espresso hover:text-gold transition-colors z-20"
