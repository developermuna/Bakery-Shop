...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-bento-black text-white pt-16 pb-12">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          <div className="lg:col-span-2">
            <div className="text-2xl font-serif font-bold text-white mb-6">
              <span className="bg-bento-yellow text-black px-2 py-0.5 rounded-l-md inline-block">BENTO</span><span className="bg-black text-bento-yellow px-2 py-0.5 rounded-r-md border border-bento-yellow inline-block">CAKERY</span>
            </div>
            <p className="text-white/80 font-light max-w-sm mb-8 leading-relaxed">
            ...
            <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-4 max-w-md">
              <input 
                ...
                className="bg-transparent border border-cream/30 rounded-full px-6 py-3 focus:outline-none focus:border-bento-yellow text-white font-light flex-grow"
              />
              <button 
                type="submit"
                className="bg-bento-yellow text-white px-8 py-3 rounded-full font-medium hover:bg-bento-black transition-colors whitespace-nowrap"
              >
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-8">
              <a href="#" aria-label="Instagram" className="w-10 h-10 rounded-full bg-bento-black/10 flex items-center justify-center hover:bg-bento-yellow hover:text-white transition-colors">
              ...
              <a href="#" aria-label="Facebook" className="w-10 h-10 rounded-full bg-bento-black/10 flex items-center justify-center hover:bg-bento-yellow hover:text-white transition-colors">
              ...
              <a href="#" aria-label="YouTube" className="w-10 h-10 rounded-full bg-bento-black/10 flex items-center justify-center hover:bg-bento-yellow hover:text-white transition-colors">
        ...
        <div className="border-t border-cream/20 pt-8 flex flex-col md:flex-row justify-between items-center text-sm font-light text-white/60">
