...
export const Location: React.FC<LocationProps> = ({
  ...
  return (
    <section
      id="location"
      className="py-8 bg-bento-yellow relative overflow-hidden flex flex-col justify-center"
    >
      {/* Decorative background element */}
      <div className="absolute -left-32 -bottom-32 w-96 h-96 bg-white/20 rounded-full mix-blend-overlay filter blur-3xl opacity-60"></div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row gap-12 bg-bento-black rounded-3xl overflow-hidden shadow-soft max-w-6xl mx-auto">
          {/* Details Column */}
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="inline-flex items-center space-x-2 text-sm font-medium text-white bg-bento-grey px-4 py-2 rounded-full hover:bg-bento-yellow hover:text-white transition-colors focus:outline-none focus:ring-2 focus:ring-bento-black"
                  >
                ...
                <div>
                  ...
                  <ul className="text-bento-grey font-light space-y-1">
                    <li className="flex justify-between w-48">
                      <span>Mon - Fri</span>
                      <span className="font-medium text-white">7am - 6pm</span>
                    </li>
                    <li className="flex justify-between w-48">
                      <span>Saturday</span>
              ...
              <div className="flex items-start space-x-4 pt-8">
                ...
                <div className="flex-1 flex flex-col sm:flex-row sm:items-center sm:space-x-8 space-y-4 sm:space-y-0">
                  <div>
                    <h3 className="text-sm font-serif text-white font-bold mb-1">
                      Call Us
                    </h3>
                    <a
                      href="tel:+15551234567"
                      className="text-bento-grey font-light hover:text-bento-yellow transition-colors block"
                    >
                      (555) 123-4567
                    </a>
                  </div>
                  <div>
                    <h3 className="text-sm font-serif text-white font-bold mb-1 flex items-center space-x-2">
                      <Mail className="w-4 h-4 text-bento-yellow inline mr-1" />{" "}
                      Email Us
                    </h3>
                    <a
          ...
          <div className="w-full lg:w-1/2 flex flex-col">
            {/* Embedded Map */}
            <div className="h-[400px] lg:h-full w-full bg-bento-black">
              <iframe
                src={mapUrl}
                width="100%"
                height="100%"
