...
export const Story: React.FC = () => {
  return (
    <section id="story" className="py-16 bg-bento-bg">
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center gap-16">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-serif text-bento-text mb-6">Our Story</h2>
            <p className="text-base text-bento-text font-light mb-6 leading-relaxed">
            ...
            <p className="text-base text-bento-text font-light mb-8 leading-relaxed">
            ...
            <div className="grid grid-cols-2 gap-8 border-t border-bento-grey pt-8">
              <div>
                <span className="block text-2xl font-serif text-bento-text font-bold mb-1">10+</span>
                <span className="text-sm uppercase tracking-wider text-bento-text font-medium">Years of Baking</span>
              </div>
              <div>
                <span className="block text-2xl font-serif text-bento-text font-bold mb-1">100%</span>
                <span className="text-sm uppercase tracking-wider text-bento-text font-medium">Handcrafted</span>
              </div>
            </div>
          </motion.div>
        </div>
