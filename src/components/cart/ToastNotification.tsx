          ...
          return (
            <motion.div
              ...
              className={`pointer-events-auto flex items-start p-4 rounded-2xl shadow-2xl backdrop-blur-md transition-all ${
                isSuccess
                  ? 'bg-bento-black/95 border-bento-yellow/40 text-white'
                  : isError
                  ? 'bg-red-50/95 border-red-200 text-red-900'
                  : 'bg-bento-grey/95 border-bento-black/20 text-white'
              }`}
              role="alert"
            >
              ...
              <div className="flex-1 mr-2">
                ...
                {toast.action && (
                  <button
                    ...
                    className="mt-2 text-xs font-semibold text-white underline hover:text-bento-yellow transition-colors focus:outline-none"
                  >
                    {toast.action.label}
                  </button>
                )}
              ...
              <button
                ...
                className="flex-shrink-0 text-bento-grey hover:text-white p-1 rounded-full hover:bg-black/5 transition-colors focus:outline-none"
