  ...
  return (
    <div className="pt-28 pb-24 bg-cream min-h-screen">
      <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
        ...
        <div className="mb-10 max-w-3xl mx-auto">
          <div className="flex items-center justify-between relative">
            ...
            <div className="flex flex-col items-center relative z-10">
              <div className="w-9 h-9 rounded-full bg-bento-black text-cream font-bold text-xs flex items-center justify-center ring-4 ring-cream shadow-sm">
                1
              </div>
              <span className="text-xs font-semibold text-bento-black mt-2">1. Your Cart</span>
            </div>
        ...
        <div className="bg-bento-yellow/10 border border-bento-yellow/30 rounded-3xl p-4 sm:p-5 mb-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex items-center space-x-3.5">
            <div className="w-10 h-10 rounded-2xl bg-bento-yellow/20 flex items-center justify-center text-bento-black flex-shrink-0">
              <MapPin className="w-5 h-5 text-bento-yellow" />
            </div>
            <div>
              <h4 className="font-serif font-bold text-bento-black text-sm sm:text-base">
          ...
          <div className="text-xs font-semibold text-bento-black bg-cream/80 px-4 py-2 rounded-full border border-beige flex items-center gap-1.5 self-stretch sm:self-auto justify-center">
        ...
        {items.length === 0 ? (
          ...
          >
            <div className="w-24 h-24 bg-beige/80 rounded-full flex items-center justify-center mx-auto mb-6 text-bento-black/40">
              <ShoppingBag className="w-12 h-12" />
            </div>
            <h2 className="text-3xl font-serif font-bold text-bento-black mb-3">
            ...
            <Link
              to="/menu"
              className="inline-flex items-center space-x-2 px-8 py-4 bg-bento-black text-cream rounded-full font-medium text-sm hover:bg-bento-black/90 transition-colors shadow-soft"
            >
            ...
            <div className="mt-16 pt-10 border-t border-beige text-left">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {MOCK_PRODUCTS.slice(0, 2).map((prod) => (
                  <div
                    key={prod.id}
                    className="p-3 bg-cream rounded-2xl border border-beige flex items-center space-x-3.5 hover:border-bento-yellow/50 transition-colors"
                  >
                    <img
                    ...
                    <div className="flex-1 min-w-0">
                      <h5 className="font-serif font-bold text-bento-black text-xs truncate">
                        {prod.name}
                      </h5>
                    ...
                    <Link
                      to="/menu"
                      className="text-xs font-semibold text-bento-black hover:text-bento-yellow px-3 py-1.5 rounded-full border border-beige hover:bg-beige/40 transition-colors"
                    >
                      View
                    </Link>
                  </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="space-y-4">
                {items.map((item) => (
                  <motion.div
                    ...
                    className="bg-off-white border border-beige rounded-3xl p-5 sm:p-6 shadow-soft relative group hover:border-bento-yellow/40 transition-all"
                  >
                    <div className="flex flex-col sm:flex-row sm:items-start gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between">
                          <div>
                            <h3 className="font-serif font-bold text-bento-black text-lg leading-tight">
                              {item.name}
                            </h3>
                          ...
                          <div className="text-right">
                            <span className="text-lg font-bold font-serif text-bento-black block">
                        ...
                        <div className="mt-3 flex flex-wrap gap-2 text-xs">
                          <span className="px-3 py-1 bg-beige rounded-full font-medium text-bento-black">
                            {item.selectedSize?.label} ({item.selectedSize?.servings} servings)
                          </span>
                          {item.selectedFlavor && (
                            <span className="px-3 py-1 bg-beige rounded-full text-bento-grey">
                              {item.selectedFlavor}
                            </span>
                          )}
                          <span className="px-3 py-1 bg-bento-yellow/10 text-bento-black rounded-full text-[11px] font-semibold flex items-center gap-1">
                        ...
                        {item.cakeMessage && (
                          <div className="mt-3 p-2.5 bg-cream rounded-xl border border-beige/80 text-xs text-bento-black italic flex items-center gap-2">
                        ...
                        <div className="mt-4 pt-4 border-t border-beige flex flex-wrap items-center justify-between gap-3">
                          ...
                          <div className="flex items-center border border-beige bg-cream rounded-full overflow-hidden shadow-xs">
                            <button
                              ...
                              className="px-3 py-1.5 hover:bg-beige text-bento-black transition-colors"
                              aria-label="Decrease quantity"
                            >
                              <Minus className="w-3.5 h-3.5" />
                            </button>
                            <span className="px-3 text-xs font-bold text-bento-black min-w-[24px] text-center">
                              {item.quantity}
                            </span>
                            <button
                              onClick={() => {
                          ...
                          <div className="flex items-center space-x-3 text-xs font-medium">
                            <button
                              ...
                              className="inline-flex items-center space-x-1 text-bento-grey hover:text-bento-black transition-colors"
                            >
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2.5">
                    ...
                    <h3 className="font-serif font-bold text-bento-black text-lg">
                      Schedule Bakery Pickup
                    </h3>
                  </div>
                  <span className="text-xs font-semibold text-bento-black bg-bento-yellow/10 px-3 py-1 rounded-full">
                ...
                <p className="text-xs text-bento-grey font-light">
                  ...
                  <strong className="text-bento-black">{earliestPickupDate}</strong>.
                </p>

                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                  <div>
                    <label className="block text-xs font-semibold text-bento-black mb-1.5">
                      Pickup Date *
                    </label>
                    <input
                      type="date"
                      ...
                      className="w-full bg-cream border border-beige rounded-xl px-4 py-3 text-sm text-bento-black focus:outline-none focus:border-bento-yellow"
                    />
                  </div>
              ...
              <div className="bg-off-white border border-beige rounded-3xl p-6 shadow-soft">
                <label className="block font-serif font-bold text-bento-black text-base mb-2">
                ...
                <textarea
                  ...
                  className="w-full bg-cream border border-beige rounded-2xl p-4 text-sm text-bento-black focus:outline-none focus:border-bento-yellow"
                />
              </div>
              ...
              {savedForLater.length > 0 && (
                <div className="pt-6 border-t border-beige space-y-4">
                  <h3 className="font-serif font-bold text-bento-black text-xl">
                    ...
                    {savedForLater.map((saved) => (
                      ...
                      >
                        <div className="flex items-center space-x-3">
                          ...
                          />
                          <div>
                            <h4 className="font-serif font-bold text-bento-black text-sm">
                              {saved.name}
                            </h4>
                        ...
                        <div className="flex items-center space-x-3">
                          <button
                            ...
                            className="text-xs font-semibold text-bento-black hover:text-bento-yellow px-3.5 py-1.5 rounded-full border border-beige bg-off-white hover:bg-beige/40 transition-colors"
                          >
                            Move to Cart
                          </button>
                          <button
            ...
            <div className="lg:col-span-5 sticky top-24 space-y-6">
              <div className="bg-off-white border border-beige rounded-3xl p-6 sm:p-8 shadow-soft space-y-6">
                <h3 className="font-serif font-bold text-bento-black text-2xl pb-4 border-b border-beige">
                  Order Summary
                </h3>
                ...
                <div>
                  <form onSubmit={handleApplyPromo} className="flex gap-2">
                    <div className="relative flex-1">
                      ...
                      <input
                        ...
                        className="w-full bg-cream border border-beige rounded-2xl pl-10 pr-4 py-3 text-xs sm:text-sm text-bento-black uppercase tracking-wider focus:outline-none focus:border-bento-yellow"
                      />
                    </div>
                    <button
                      type="submit"
                      className="px-5 py-3 bg-beige hover:bg-bento-yellow/20 text-bento-black font-semibold text-xs rounded-2xl border border-beige transition-colors"
                    >
                      Apply
                    </button>
                  </form>
                  ...
                  {appliedDiscount && (
                    <div className="mt-3 bg-bento-yellow/15 border border-bento-yellow/30 rounded-xl p-2.5 flex items-center justify-between text-xs">
                      <div className="flex items-center gap-1.5 text-bento-black font-medium">
                      ...
                      <button
                        ...
                        className="text-bento-grey/70 hover:text-bento-black font-semibold text-[11px]"
                      >
                        Remove
                      </button>
                    </div>
                ...
                <div className="space-y-3 text-sm pt-2 border-t border-beige">
                  ...
                  <div className="pt-4 border-t border-beige flex justify-between items-baseline font-serif">
                    <div>
                      <span className="text-xl font-bold text-bento-black block">Total Due</span>
                      <span className="text-[11px] font-sans text-bento-grey font-light">
                        Charged securely upon checkout
                      </span>
                    </div>
                    <span className="text-2xl font-extrabold text-bento-black">
                ...
                <button
                  ...
                  className="w-full py-4 px-6 bg-bento-black text-cream rounded-full font-medium text-base hover:bg-bento-black/90 transition-colors shadow-soft flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-bento-yellow"
                >
                  {isValidating ? (
                    <>
                ...
                <div className="pt-4 border-t border-beige space-y-2.5 text-xs text-bento-grey">
