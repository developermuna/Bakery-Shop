    ...
    return (
      <div className="pt-32 pb-24 bg-cream min-h-screen text-center px-4">
        <div className="max-w-md mx-auto bg-off-white p-8 rounded-3xl border border-beige shadow-soft">
          <h2 className="text-2xl font-serif font-bold text-espresso mb-3">No Items in Cart</h2>
          <p className="text-xs text-brown font-light mb-6">
            Your cart is currently empty. Please select cakes from our menu before proceeding to checkout.
          </p>
          <button
            onClick={() => navigate('/menu')}
            className="px-6 py-3 bg-espresso text-cream text-xs font-semibold rounded-full"
          >
            Go to Menu
          </button>
        </div>
  ...
  return (
    <div className="pt-28 pb-24 bg-cream min-h-screen">
      <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
        ...
        <div className="mb-10 max-w-3xl mx-auto">
          <div className="flex items-center justify-between relative">
            ...
            <div className="flex flex-col items-center relative z-10">
              <div className="w-9 h-9 rounded-full bg-gold text-espresso font-bold text-xs flex items-center justify-center ring-4 ring-cream shadow-xs">
                ✓
              </div>
              <span className="text-xs text-brown/70 mt-2">1. Your Cart</span>
            </div>
            ...
            <div className="flex flex-col items-center relative z-10">
              ...
              <span
                className={`text-xs mt-2 ${
                  currentStep === 2 ? 'font-semibold text-espresso' : 'text-brown/70'
                }`}
              >
                2. Pickup Details
              </span>
            ...
            <div className="flex flex-col items-center relative z-10">
              ...
              <span
                className={`text-xs mt-2 ${
                  currentStep === 3 ? 'font-semibold text-espresso' : 'text-brown/70'
                }`}
              >
                3. Payment
              </span>
        ...
        {/* Pickup Notice */}
        <div className="bg-beige/60 border border-beige rounded-2xl px-5 py-3 mb-8 flex items-center justify-between text-xs text-brown">
          <div className="flex items-center space-x-2 font-medium text-espresso">
            <MapPin className="w-4 h-4 text-gold flex-shrink-0" />
            <span>Pickup Location: Main Road, Near New Bus Stand, Rayagada, Odisha</span>
          </div>
          <span className="text-[11px] text-brown font-light hidden sm:inline">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full bg-cream border rounded-xl px-4 py-2.5 text-sm text-espresso focus:outline-none focus:border-gold ${
                ...
                <div className="space-y-4 pt-4 border-t border-beige">
                  <div className="flex items-center justify-between">
                    <h3 className="text-sm font-serif font-bold text-espresso flex items-center gap-1.5">
                ...
                <div className="pt-4 border-t border-beige">
                  ...
                  <textarea
                    ...
                    className="w-full bg-cream border border-beige rounded-xl p-3 text-xs text-espresso focus:outline-none focus:border-gold"
                  />
                </div>
                ...
                <div className="pt-4 flex justify-between items-center">
                  <button
                    ...
                    className="inline-flex items-center space-x-1.5 text-xs font-semibold text-brown hover:text-espresso"
                  >
                  ...
                  <button
                    type="submit"
                    className="px-8 py-3.5 bg-espresso text-cream text-xs font-semibold uppercase tracking-wider rounded-full hover:bg-espresso/90 transition-colors shadow-soft inline-flex items-center space-x-2"
                  >
              ...
              >
                ...
                <div className="bg-cream p-4 rounded-2xl border border-beige text-xs space-y-1">
                  <div className="flex justify-between">
                    <span className="text-brown">Customer:</span>
                    <strong className="text-espresso">{name} ({phone})</strong>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-brown">Scheduled Pickup:</span>
                    <strong className="text-espresso">{pickupDate} at {pickupTimeSlot}</strong>
                  </div>
                </div>

                {/* Stripe Elements Mock Card Field */}
                <div className="space-y-4 pt-2">
                  <label className="block text-xs font-semibold text-espresso flex items-center gap-1.5">
                  ...
                  <div className="space-y-3">
                    <div>
                      <input
                        ...
                        className="w-full bg-cream border border-beige rounded-xl px-4 py-3 text-sm text-espresso font-mono tracking-wider focus:outline-none focus:border-gold"
                      />
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      <div>
                        <input
                          ...
                          placeholder="MM/YY"
                          className="w-full bg-cream border border-beige rounded-xl px-3 py-2.5 text-xs text-espresso text-center font-mono focus:outline-none focus:border-gold"
                        />
                      </div>
                      <div>
                        <input
                      ...
                      <div>
                        <input
                          ...
                          className="w-full bg-cream border border-beige rounded-xl px-3 py-2.5 text-xs text-espresso text-center focus:outline-none focus:border-gold"
                        />
                      </div>
                    </div>
                  </div>
                ...
                <div className="bg-beige/40 p-4 rounded-2xl border border-beige flex items-center space-x-3 text-xs text-brown">
                  <ShieldCheck className="w-5 h-5 text-gold flex-shrink-0" />
                  <p>
                    Your card will be charged{' '}
                    <strong className="text-espresso">{formatCurrency(totals.total)}</strong> upon
                ...
                <div className="pt-4 flex justify-between items-center">
                  ...
                  <button
                    ...
                    className="px-8 py-3.5 bg-espresso text-cream text-xs font-semibold uppercase tracking-wider rounded-full hover:bg-espresso/90 transition-colors shadow-soft inline-flex items-center space-x-2 disabled:opacity-60"
                  >
                    {isProcessing ? (
                      <>
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="bg-off-white border border-beige rounded-3xl p-6 sm:p-8 shadow-soft space-y-5 sticky top-24">
              <h3 className="font-serif font-bold text-espresso text-xl pb-3 border-b border-beige">
                  ...
                  <div key={item.id} className="flex items-center justify-between text-xs py-1">
                    <div className="flex items-center space-x-2.5 min-w-0 pr-2">
                      ...
                      <div className="truncate">
                        <span className="font-medium text-espresso block truncate">
                          {item.name}
                        </span>
                    ...
                    <span className="font-semibold text-espresso flex-shrink-0">
              ...
              <div className="space-y-2 pt-4 border-t border-beige text-xs">
                ...
                <div className="flex justify-between text-base font-bold text-espresso pt-3 border-t border-beige font-serif">
                  <span>Total</span>
              ...
              {/* Security guarantee */}
              <div className="pt-2 flex items-center justify-center space-x-1.5 text-[11px] text-brown font-light">
